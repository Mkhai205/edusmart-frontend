...
import type { AuthErrorCode, AuthErrorInfo, AuthRefreshResponse, AuthUser } from "@/types/auth";

const AUTH_ERROR_MESSAGES: Record<AuthErrorCode, string> = {
    missing_google_code: "Google không trả về mã xác thực. Vui lòng thử đăng nhâp lại.",
    invalid_oauth_state: "Phiên đăng nhâp không hơp lệ hoặc đã hết hạn. Vui lòng thử lại.",
    google_auth_failed: "Đăng nhâp bằng Google thất bại. Vui lòng thử lại sau ít phút.",
    session_init_failed: "Không thể khởi tạo phiên đăng nhập. Vui lòng thử lại.",
    unknown_auth_error: "Đã xảy ra lỗi không xác định trong quá trình đăng nhập.",
};
