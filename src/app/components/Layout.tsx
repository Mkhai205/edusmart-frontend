...
export function Layout({ children }: LayoutProps) {
    ...
    const [reminderChannelFilter, setReminderChannelFilter] = useState<"all" | ReminderChannel>(
        "all",
    );
        ...
        try {
            ...
            const [feed, preferences] = await Promise.all([
                listReminderFeed(
                    12,
                    0,
                    reminderChannelFilter === "all" ? undefined : reminderChannelFilter,
                ),
                getReminderPreferences(),
            ]);
    ...
    return (
        <div className="min-h-screen bg-[#f4fae8] font-sans text-gray-800 flex flex-col">
                    ...
                    <div className="flex flex-col gap-2 py-1.5 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
                        <div className="flex items-center gap-6 min-w-0">
                            ...
                            >
                                ...
                                <span className="font-semibold text-base text-[#00A651] leading-none">
                                    EduSmart
                                </span>
                            </Link>
            ...
            {/* Main Content */}
            <main className="flex-1 w-full mx-auto px-4 pb-6 pt-3 sm:px-6 sm:pt-4 sm:pb-8 lg:px-8 lg:pt-5">
                {children}
            </main>
                                    ...
                                    onChange={(e) =>
                                        setReminderPreferences((prev) =>
                                            prev
                                                ? {
                                                      ...prev,
                                                      overdue_cooldown_hours: Math.max(
                                                          1,
                                                          Number(e.target.value) || 1,
                                                      ),
                                                  }
